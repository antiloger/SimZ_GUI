...
class ProjectManager:
    ...
    def create_run(self, project_name: str, run_name: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    def register_component(self, project_name: str, component_name: str, 
                          python_code: str, input_schema: Dict, output_schema: Dict) -> Dict[str, Any]:
        """
    ...
    def save_simulation_state(self, project_name: str, run_id: str, 
                             state_name: str, data: Dict) -> Dict[str, Any]:
        """
        ...
        file_path = self.file_manager.save_state_data(project_name, run_id, state_name, data)
    ...
    def get_simulation_state(self, project_name: str, run_id: str, 
    ...
    def save_simulation_output(self, project_name: str, run_id: str, 
                              output_name: str, data: Dict) -> Dict[str, Any]:
        """
        ...
        file_path = self.file_manager.save_output_data(project_name, run_id, output_name, data)
    ...
    def get_simulation_output(self, project_name: str, run_id: str, 
